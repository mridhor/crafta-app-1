...
VALUES
    ('d1111111-1111-1111-1111-111111111111', 'b3e3e3e3-3e3e-3e3e-3e3e-3e3e3e3e3e3e', 'c1111111-1111-1111-1111-111111111111', 'p1111111-1111-1111-1111-111111111111', 'd0d8c19c-3b36-4421-8979-233d625516a3', 'TechNova Enterprise License', 150000, 'negotiation', 80, current_date + interval '15 days', 'low', 'on_track', 5),
    ('d2222222-2222-2222-2222-222222222222', 'b3e3e3e3-3e3e-3e3e-3e3e-3e3e3e3e3e3e', 'c2222222-2222-2222-2222-222222222222', 'p3333333-3333-3333-3333-333333333333', 'd0d8c19c-3b36-4421-8979-233d625516a3', 'GreenField Solar Project', 450000, 'proposal', 60, current_date + interval '45 days', 'medium', 'slowing_down', 12),
    ('d3333333-3333-3333-3333-333333333333', 'b3e3e3e3-3e3e-3e3e-3e3e-3e3e3e3e3e3e', 'c3333333-3333-3333-3333-333333333333', 'p4444444-4444-4444-4444-444444444444', 'd0d8c19c-3b36-4421-8979-233d625516a3', 'BlueSky Fleet Management', 75000, 'discovery', 30, current_date + interval '60 days', 'low', 'accelerating', 2),
    ...
    ('d5555555-5555-5555-5555-555555555555', 'b3e3e3e3-3e3e-3e3e-3e3e-3e3e3e3e3e3e', 'c5555555-5555-5555-5555-555555555555', 'p5555555-5555-5555-5555-555555555555', 'd0d8c19c-3b36-4421-8979-233d625516a3', 'Nebula Diagnostics Platform', 300000, 'closed_won', 100, current_date - interval '5 days', 'low', 'on_track', 0)
ON CONFLICT (id) DO NOTHING;
...
VALUES
    ('r1111111-1111-1111-1111-111111111111', 'b3e3e3e3-3e3e-3e3e-3e3e-3e3e3e3e3e3e', 'd0d8c19c-3b36-4421-8979-233d625516a3', 'd1111111-1111-1111-1111-111111111111', 'p1111111-1111-1111-1111-111111111111', 'Send contract for review', 'Sarah requested the final contract draft by EOD.', 'email', 'urgent', 'pending', now() + interval '2 hours', 'Draft sent to legal. Ready for review.', 0.95),
    ('r2222222-2222-2222-2222-222222222222', 'b3e3e3e3-3e3e-3e3e-3e3e-3e3e3e3e3e3e', 'd0d8c19c-3b36-4421-8979-233d625516a3', 'd2222222-2222-2222-2222-222222222222', 'p3333333-3333-3333-3333-333333333333', 'Schedule technical deep dive', 'Need to address concerns about integration.', 'meeting', 'high', 'pending', now() + interval '1 day', 'Suggest times: Tue 2pm, Wed 10am.', 0.88),
    ('r3333333-3333-3333-3333-333333333333', 'b3e3e3e3-3e3e-3e3e-3e3e-3e3e3e3e3e3e', 'd0d8c19c-3b36-4421-8979-233d625516a3', 'd3333333-3333-3333-3333-333333333333', 'p4444444-4444-4444-4444-444444444444', 'Follow up on proposal', 'Proposal sent 3 days ago, no response.', 'call', 'medium', 'pending', now() + interval '2 days', 'Call script prepared based on last interaction.', 0.75)
ON CONFLICT (id) DO NOTHING;
...
VALUES
    ('e1111111-1111-1111-1111-111111111111', 'b3e3e3e3-3e3e-3e3e-3e3e-3e3e3e3e3e3e', 'd0d8c19c-3b36-4421-8979-233d625516a3', 'd1111111-1111-1111-1111-111111111111', 'p1111111-1111-1111-1111-111111111111', 'Contract Review with TechNova', 'Finalizing terms.', 'meeting', now() + interval '1 day 10 hours', now() + interval '1 day 11 hours', 'confirmed'),
    ('e2222222-2222-2222-2222-222222222222', 'b3e3e3e3-3e3e-3e3e-3e3e-3e3e3e3e3e3e', 'd0d8c19c-3b36-4421-8979-233d625516a3', 'd2222222-2222-2222-2222-222222222222', 'p3333333-3333-3333-3333-333333333333', 'GreenField Sync', 'Weekly sync.', 'call', now() + interval '2 days 14 hours', now() + interval '2 days 14 hours 30 minutes', 'tentative')
ON CONFLICT (id) DO NOTHING;

-- Create Intake Queue Items
INSERT INTO public.intake_queue (id, workspace_id, source, status, raw_data, email, company_name, confidence_score)
VALUES
    ('i1111111-1111-1111-1111-111111111111', 'b3e3e3e3-3e3e-3e3e-3e3e-3e3e3e3e3e3e', 'web_form', 'pending', '{"subject": "Enterprise Pricing Inquiry", "body": "Hi, we are interested in your enterprise plan. We have 500 seats.", "from_email": "alice@bigcorp.com", "company": "BigCorp"}', 'alice@bigcorp.com', 'BigCorp', 0.92),
    ('i2222222-2222-2222-2222-222222222222', 'b3e3e3e3-3e3e-3e3e-3e3e-3e3e3e3e3e3e', 'email', 'pending', '{"subject": "Partnership Opportunity", "body": "Would love to discuss a partnership.", "from_email": "bob@partner.io", "company": "PartnerIO"}', 'bob@partner.io', 'PartnerIO', 0.65),
    ('i3333333-3333-3333-3333-333333333333', 'b3e3e3e3-3e3e-3e3e-3e3e-3e3e3e3e3e3e', 'chat', 'rejected', '{"message": "Can you help me with support?", "email": "support@customer.com"}', 'support@customer.com', null, 0.20)
ON CONFLICT (id) DO NOTHING;
